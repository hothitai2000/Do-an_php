...
<body>
    ...
    if (isset($_POST["btn"])) {
        ...
        if (empty($ten_file)) {
            ...
            $connect = mysqli_connect("localhost", "root", "", "product") or die("connect fail!");
            $check = "select*from thanhvien where taikhoan='$taikhoan'";
            ...
            if ($dem > 0) {
                ...
                $sql = "INSERT INTO thanhvien (taikhoan, matkhau, avatar, Ghichu) values('$taikhoan', '$matkhau','$target_path','$ghichu')";
